  ...
  return (
    <div className='container'>
      ...
      <p className='text'>
        ...
        Our mission is to provide quality information and entertainment for our audience. Whether you're here to read insightful posts or explore movies, we're glad to have you!
      </p>
      <p className='text'>
